  ...
  "node_modules/@chec/commerce.js/lib/index.js"(exports, module) {
    ...
    var Storage = function() {
      ...
      return _createClass__default.default(Storage2, [{ key: "set", value: function(key, value, days) {
        if (typeof document == "undefined" || this.commerce.options.disableStorage)
          return null;
        var path, expires = "";
        if (path = this.commerce.options.config && this.commerce.options.config.cookie_path !== void 0 ? this.commerce.options.config.cookie_path : "/", days) {
          var date = new Date();
    ...
    var Cart = function() {
      ...
      return _createClass__default.default(Cart2, [{ key: "refresh", value: function() {
        ...
        return typeof storedCartId == "string" && storedCartId.length ? storedCartId : null;
        ...
        return _regeneratorRuntime__default.default.wrap(function(_context) {
          for (; ; )
            switch (_context.prev = _context.next) {
              case 0:
                if (endpoint = _args.length > 0 && _args[0] !== void 0 ? _args[0] : "", method = _args.length > 1 && _args[1] !== void 0 ? _args[1] : "get", data = _args.length > 2 && _args[2] !== void 0 ? _args[2] : null, returnFullRequest = _args.length > 3 && _args[3] !== void 0 && _args[3], suffix = typeof endpoint == "string" && endpoint.length ? "/".concat(endpoint) : "", this.id()) {
                  _context.next = 8;
                  break;
                }
                return _context.next = 8, this.refresh();
              case 8:
                return _context.abrupt("return", this.commerce.request("carts/".concat(this.id()).concat(suffix), method, data, returnFullRequest).catch(function(error3) {
                  if (error3.statusCode && error3.statusCode === 404)
        ...
        var quantity = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, variantData = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, validatedVariant = {};
        if (typeof variantData == "string" && variantData.startsWith("vrnt"))
          validatedVariant.variant_id = variantData;
        else if (variantData && _typeof__default.default(variantData) === "object") {
        ...
        var data = _objectSpread({ id: _typeof__default.default(productId) === "object" ? productId.id : productId, quantity }, validatedVariant);
        return this.request("", "post", data);
      } }, { key: "retrieve", value: function() {
        var _this3 = this, cartId = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
      ...
      } }, { key: "update", value: function(lineId, data) {
    ...
    var Categories = function() {
      ...
      return _createClass__default.default(Categories2, [{ key: "list", value: function() {
        ...
        return typeof params == "function" ? this.commerce.request("categories") : this.commerce.request("categories", "get", params);
    ...
    var Checkout = function() {
      ...
      } }, { key: "generateToken", value: function(identifier, data) {
      ...
      } }, { key: "capture", value: function(token, data) {
        var _this = this;
      ...
      } }, { key: "receipt", value: function(token) {
        return this.commerce.request("checkouts/".concat(token, "/receipt"));
      } }, { key: "checkPayWhatYouWant", value: function(token, data) {
    ...
    var Customer = function() {
      ...
      return _createClass__default.default(Customer2, [{ key: "login", value: function(email, baseUrl) {
        ...
        var _this = this, save = !(arguments.length > 1 && arguments[1] !== void 0) || arguments[1];
        return this.commerce.request("customers/exchange-token", "post", { token }).then(function(result) {
        ...
        var data = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, customerId = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, token = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
        ...
        var customerId = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, token = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        ...
        var customerId = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null, token = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
        ...
        return typeof storedValue == "string" && storedValue.length ? storedValue : null;
      } }, { key: "_request", value: function(endpoint) {
        var method = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "get", data = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, extraHeaders = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, token = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null, authToken = token || this.token();
        return this.commerce.request(endpoint, method, data, _objectSpread$1({ "X-Authorization": void 0, Authorization: "Bearer ".concat(authToken) }, extraHeaders));
      } }, { key: "_assertArgsProvided", value: function() {
        var customerId = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, token = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
    ...
    var Services = function() {
      ...
      } }, { key: "localeListShippingCountries", value: function(token) {
        return this.commerce.request("services/locale/".concat(token, "/countries"));
      } }, { key: "localeListShippingSubdivisions", value: function(token, countryCode) {
    ...
    var consoleHelper = function() {
      var emoji, messages, color = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "black", a = arguments.length > 1 ? arguments[1] : void 0, b = arguments.length > 2 ? arguments[2] : void 0, c = arguments.length > 3 ? arguments[3] : void 0, isError = false;
      switch (color) {
        case "success":
          color = "#488f5a", emoji = "\u2705   ";
          break;
        case "info":
          ...
          break;
        case "error":
          color = "rgba(244, 67, 54, 1)", c.error.type === "validation" || c.error.type === "unprocessable_entity" ? (emoji = "\u{1F6AB} Validation/missing fields", a = "") : emoji = "\u274C HTTP ERROR ", isError = true;
          break;
        case "warning":
          color = "rgba(208, 154, 35, 1)", emoji = "\u26A0\uFE0F  ";
      }
      return isError === true ? (console.log("%c" + emoji + a, "color:" + color + ";display:block; width: 100%;padding:2px 2px 2px 0px;font-family: Open Sans, Helvetica, Sans-serif;font-weight:bold;background-color:rgba(244, 67, 54, 0.15);"), _typeof__default.default(c.error.errors) === "object" ? (messages = c.error.errors, void Object.keys(messages).forEach(function(key, index2) {
    ...
    var Commerce = function() {
      function Commerce2(publicKey) {
        var debug = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], config = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
        if (_classCallCheck__default.default(this, Commerce2), this.options = _objectSpread$2(_objectSpread$2({ version: "v1", url: "https://api.chec.io/", eventCallback: defaultEventCallback, disableStorage: false, cartLifetime: 30 }, config), {}, { publicKey, debug }), typeof publicKey != "string" || publicKey.length === 0)
      ...
      return _createClass__default.default(Commerce2, [{ key: "error", value: function(response) {
        if (this.consoleHelper && this.options.debug) {
          var innerResponse = response.response, type = "[".concat(innerResponse.status, "] Type: ").concat(innerResponse.statusText), msg = typeof innerResponse.data == "string" ? innerResponse.data : innerResponse.statusText;
          return this.consoleHelper("error", type, msg, innerResponse.data);
        }
      } }, { key: "request", value: function(endpoint) {
        var _this = this, method = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "get", data = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, extraHeaders = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, returnFullResponse = arguments.length > 4 && arguments[4] !== void 0 && arguments[4], headers = { "X-Authorization": this.options.publicKey, "X-Chec-Agent": "commerce.js/v2", "Content-Type": "application/json" }, params = method === "get" ? data : null, requestBody = method === "get" ? null : data, timeout = this.options.timeoutMs || 6e4, axiosConfig = this.options.axiosConfig || {}, baseUrl = this.options.url;
        ...
        return promise.then(function(response) {
          if (_this.consoleHelper && _this.options.debug && _typeof__default.default(response.data._console) === "object" && _this.consoleHelper.apply(_this, _toConsumableArray__default.default(response.data._console)), _typeof__default.default(response.data) !== "object" || Array.isArray(response.data))
          ...
          return typeof _event == "string" && typeof eventCallback == "function" && eventCallback(_event), otherData;
        }).catch(function(error3) {
          if (_this.error(error3), !error3.response)
            throw error3;
          throw { message: "Unsuccessful response (".concat(error3.response.status, ": ").concat(error3.response.statusText, ") received"), statusCode: error3.response.status, statusText: error3.response.statusText, data: error3.response.data, originalError: error3 };
        });
      } }]), Commerce2;
    }();
...
// .svelte-kit/output/server/app.js
var import_commerce = __toModule(require_lib());
function run(fn) {
  return fn();
}
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-d53c7259.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-d53c7259.js", "/./_app/chunks/vendor-2d83f193.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "storefront.png", "size": 3332, "type": "image/png" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/categories\/([^/]+?)\/?$/,
      params: (m) => ({ slug: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/categories/[slug].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/products\/([^/]+?)\/?$/,
      params: (m) => ({ permalink: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/products/[permalink].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/categories/[slug].svelte": () => Promise.resolve().then(function() {
    return _slug_;
  }),
  "src/routes/products/[permalink].svelte": () => Promise.resolve().then(function() {
    return _permalink_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-2e3f51e3.js", "css": ["/./_app/assets/pages/__layout.svelte-f1f02266.css"], "js": ["/./_app/pages/__layout.svelte-2e3f51e3.js", "/./_app/chunks/vendor-2d83f193.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-43cfc1f9.js", "css": [], "js": ["/./_app/error.svelte-43cfc1f9.js", "/./_app/chunks/vendor-2d83f193.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-d46315f8.js", "css": ["/./_app/assets/pages/index.svelte-a9b68312.css"], "js": ["/./_app/pages/index.svelte-d46315f8.js", "/./_app/chunks/vendor-2d83f193.js", "/./_app/chunks/commerce-5a55d1b7.js"], "styles": [] }, "src/routes/categories/[slug].svelte": { "entry": "/./_app/pages/categories/[slug].svelte-dd94cd88.js", "css": ["/./_app/assets/pages/index.svelte-a9b68312.css"], "js": ["/./_app/pages/categories/[slug].svelte-dd94cd88.js", "/./_app/chunks/vendor-2d83f193.js", "/./_app/chunks/commerce-5a55d1b7.js"], "styles": [] }, "src/routes/products/[permalink].svelte": { "entry": "/./_app/pages/products/[permalink].svelte-1eec0db9.js", "css": ["/./_app/assets/pages/products/[permalink].svelte-6acd0608.css"], "js": ["/./_app/pages/products/[permalink].svelte-1eec0db9.js", "/./_app/chunks/vendor-2d83f193.js", "/./_app/chunks/commerce-5a55d1b7.js"], "styles": [] } };
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container"}"><div class="${"flex space-x-24 justify-center"}"><div class="${"flex-col my-4"}"><h3 class="${"text-2xl mb-4 border-b"}">Categories</h3>
			<ul class="${"list-unstyled"}">${each(categories, (category) => `<li class="${"py-1"}"><a rel="${"prefetch"}" href="${"/categories/" + escape2(category.slug)}" class="${"svelte-14ezsc1"}">${escape2(category.name)}</a>
					</li>`)}</ul></div>
		<div class="${"flex-col my-4"}"><h3 class="${"text-2xl mb-4 border-b"}">Products</h3>
			<ul class="${"list-unstyled"}">${each(products, (product) => `<li class="${"py-1"}"><a rel="${"prefetch"}" href="${"/products/" + escape2(product.permalink)}" class="${"svelte-14ezsc1"}">${escape2(product.name)}</a>
					</li>`)}</ul></div></div>
</div>`;
});
...
var U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a href="${"/"}" class="${"text-xl px-6 py-4 svelte-14ezsc1"}">Back Home</a>
<div class="${"container mx-auto my-4"}"><div class="${"flex"}"><div class="${"flex-col"}"><h1 class="${"text-3xl border-b mb-4"}">${escape2(category.name)}</h1>

			<ul class="${""}">${each(products, (product) => `<li class="${"py-1"}"><a rel="${"prefetch"}" href="${"/products/" + escape2(product.permalink)}" class="${"svelte-14ezsc1"}">${escape2(product.name)}</a>
					</li>`)}</ul></div></div>
</div>`;
});
...
var css = {
  code: "img.svelte-2ooxtw{height:20rem;-o-object-fit:fill;object-fit:fill;width:auto}a.svelte-2ooxtw:hover{color:#639;text-decoration:underline}",
  map: `{"version":3,"file":"[permalink].svelte","sources":["[permalink].svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\timport { client } from '$lib/commerce.js';\\n\\n\\texport async function load({ page }) {\\n\\t\\tconst { permalink } = page?.params;\\n\\n\\t\\tconst product = await client.products.retrieve(permalink, {\\n\\t\\t\\ttype: 'permalink'\\n\\t\\t});\\n\\n\\t\\treturn {\\n\\t\\t\\tprops: {\\n\\t\\t\\t\\tproduct\\n\\t\\t\\t}\\n\\t\\t};\\n\\t}\\n<\/script>\\n\\n<script>\\n\\texport let product;\\n<\/script>\\n\\n<a href=\\"/\\" class=\\"text-xl px-6 my-4\\">Back Home</a>\\n\\n<div class=\\"container mx-auto py-4\\">\\n\\t<div class=\\"flex\\">\\n\\t\\t<div class=\\"flex-col p-8\\">\\n\\t\\t\\t<img src={product.media.source} alt=\\"\\" />\\n\\t\\t</div>\\n\\t\\t<div class=\\"flex-col p-8\\">\\n\\t\\t\\t<h1 class=\\"text-3xl mb-4\\">{product.name}</h1>\\n\\t\\t\\t<p class=\\"font-bold\\">{product.price.formatted_with_symbol}</p>\\n\\t\\t</div>\\n\\t</div>\\n</div>\\n\\n<style>img{height:20rem;-o-object-fit:fill;object-fit:fill;width:auto}a:hover{color:#639;text-decoration:underline}</style>\\n"],"names":[],"mappings":"AAoCO,iBAAG,CAAC,OAAO,KAAK,CAAC,cAAc,IAAI,CAAC,WAAW,IAAI,CAAC,MAAM,IAAI,CAAC,eAAC,MAAM,CAAC,MAAM,IAAI,CAAC,gBAAgB,SAAS,CAAC"}`
};
async function load({ page }) {
  const { permalink } = page == null ? void 0 : page.params;
  const product = await client.products.retrieve(permalink, { type: "permalink" });
  return { props: { product } };
}
var U5Bpermalinku5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { product } = $$props;
  if ($$props.product === void 0 && $$bindings.product && product !== void 0)
    $$bindings.product(product);
  $$result.css.add(css);
  return `<a href="${"/"}" class="${"text-xl px-6 my-4 svelte-2ooxtw"}">Back Home</a>

<div class="${"container mx-auto py-4"}"><div class="${"flex"}"><div class="${"flex-col p-8"}"><img${add_attribute("src", product.media.source, 0)} alt="${""}" class="${"svelte-2ooxtw"}"></div>
		<div class="${"flex-col p-8"}"><h1 class="${"text-3xl mb-4"}">${escape2(product.name)}</h1>
			<p class="${"font-bold"}">${escape2(product.price.formatted_with_symbol)}</p></div></div>
</div>`;
});
var _permalink_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
